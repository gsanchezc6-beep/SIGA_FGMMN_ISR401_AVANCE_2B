...
| 4 | La comprobacion de sumas termina sin error sobre el clon limpio | **Si** | 918 de 918 sumas correctas |
...
| 6 | Existe etiqueta anotada de linea base, publicada y alcanzable desde la rama por defecto | **Si** | 4 etiqueta(s) anotada(s) y alcanzable(s) desde main: 2B-final, 2B-final-v2.1, 2B-final-v3.0, 2B-final-v4.0 |
...
| 10 | Ningun dato personal aparece en la zona publica del repositorio | **Si** | Ninguna cedula ajena al equipo fuera de la zona restringida. Las 7 apariciones detectadas son las de los propios integrantes, declaradas por ellos en la caratula y en la composicion del equipo, no datos de participantes |
