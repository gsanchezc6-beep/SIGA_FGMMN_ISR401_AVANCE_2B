...
| 4 | La comprobacion de sumas termina sin error sobre el clon limpio | **Si** | 478 de 478 sumas correctas |
| 5 | Todos los autores del historial son integrantes declarados con correo institucional | **Si** | 2 autor(es): gsanchezc6@uteq.edu.ec, ymunozq@uteq.edu.ec |
...
| 8 | La carpeta 10_Autoria contiene los elementos A1 a A12 | **No** | Faltan: A11. Sin contenido: A2, A4, A5, A6, A7, A8 |
