...
Se registra aquí únicamente lo que puede comprobarse contra el historial del
repositorio. Cada fila cita el commit que la respalda.

| Verificación | Fecha | Evidencia en el historial |
|---|---|---|
| Enmascarado de cédula y firma en los diez consentimientos | 2026-08-26 | `173591a` |
...
con el commit que las respalde.
...
Ver también [`08_Etica/resumen_proceso_etico.md`](../08_Etica/resumen_proceso_etico.md).
