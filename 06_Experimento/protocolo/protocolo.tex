...
\begin{quote}\small
\textbf{Nota de actualizaci\'on, 2026-09-02.} El texto de este protocolo se conserva
tal como se registr\'o y no se reescribe. Dos datos han cambiado desde entonces y se
consignan aqu\'i sin alterar el original. Primero, el enlace de arriba apunta al
\emph{nodo de proyecto} \texttt{3nruf}, que es mutable; el registro congelado, que es
el que tiene DOI y el que debe citarse, es
\url{https://doi.org/10.17605/OSF.IO/7PQ3H} (\url{https://osf.io/7pq3h}). Segundo, el
estado que se declara a continuaci\'on qued\'o superado: el registro fue
\textbf{aceptado el 2026-08-02}, y el 2026-08-27 se le a\~nadieron las nueve
desviaciones. El detalle consta en
\texttt{06\_Experimento/registro\_previo/registro\_osf.md}.
\end{quote}
...
\begin{quote}\small
\textbf{Nota de actualizaci\'on, 2026-09-02.} El dep\'osito citado arriba corresponde
al estado del paquete cuando se registr\'o el protocolo. El dep\'osito vigente de la
Entrega Final, que es el declarado en \texttt{CITATION.cff} y el que acompa\~na al
manuscrito, es \url{https://doi.org/10.5281/zenodo.22137679}.
\end{quote}
