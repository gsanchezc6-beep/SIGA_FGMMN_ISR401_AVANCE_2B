...
\noindent\textbf{Composición del equipo.} La Entrega Final la sostienen \textbf{dos integrantes}, que se reparten los cuatro roles del plan. El equipo fue mayor en entregas anteriores; la composición vigente y su comprobación contra el historial del repositorio constan en \texttt{04\_Trazabilidad/composicion\_equipo.md}, y el cambio queda registrado en la bitácora de desviaciones. Ningún apartado de este documento procede de un integrante que ya no forma parte del equipo.
