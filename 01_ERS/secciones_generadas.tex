...
\begingroup
\small
\begin{longtable}{|P{0.2500}|P{0.2500}|P{0.2500}|P{0.2500}|}
\hline
...
4.0 & 30/08/2026 & Equipo FGMMN & Entrega Final (2B): consolidacion de la especificacion. Se unifican los identificadores de requisito no funcional en \texttt{RNF-}, se delimitan RF-13 y RF-16 conforme a la solicitud de cambio SC-01 aprobada por el comite de control de cambios, se incorpora la auditoria de calidad de la especificacion sobre las seis metricas de la guia, y se agregan las fichas de los componentes de inteligencia artificial. \\ \hline
4.1 & 31/08/2026 & Equipo FGMMN & Correcciones de la revision docente de la Entrega Final: se anade el resumen bilingue exigido por el criterio C1, y la subseccion 3.3.2 incorpora al documento los requisitos del unico componente de inteligencia artificial del sistema --- rendimiento, equidad, explicabilidad, datos de entrenamiento, plan de monitoreo y clasificacion de riesgo ---, que hasta ahora solo constaban en la ficha anexa. \\ \hline
4.2 & 31/08/2026 & Equipo FGMMN & Se etiquetan los criterios de aceptacion CA-01 a CA-17, que la matriz de trazabilidad referenciaba sin que existieran en el documento, y se anaden las historias HU-18, HU-19 y HU-20 con sus criterios para RF-20, RF-24 y RF-25, que no tenian ninguna. \\ \hline
4.3 & 31/08/2026 & Equipo FGMMN & Se aplican las decisiones del comite de control de cambios CCB-01: RF-12 fija plazo de primera respuesta por prioridad y estados intermedios visibles (SC-02), y RF-24 y RF-25 pasan a Must por ser obligaciones legales (SC-04). RF-11 dirige la notificacion al tecnico asignado. Cada ficha declara ahora de que requisitos depende y a cuales alimenta. Esta version corresponde a la linea base \textbf{v2.1} acordada en CCB-01. SC-03 queda diferida a verificacion tecnica, de modo que RF-06 no se modifica. \\ \hline
4.4 & 03/09/2026 & Equipo FGMMN & Se atiende la seccion 8 de la guia de desarrollo individualizada: la subseccion 3.3.3 especifica los ocho requisitos no funcionales del componente inteligente, RNF-IA-01 a RNF-IA-08, con enunciado verificable, metrica, unidad, umbral, metodo de verificacion, responsable y frecuencia de medicion, y los ocho se incorporan a la matriz de trazabilidad con su elemento de diseno y su caso de prueba. Se anade el plan de monitoreo posterior al despliegue con once indicadores. El documento se recompone en A4. Se actualiza el Anexo A.1 con la reincorporacion de un integrante y la retirada de otro. \\ \hline
4.5 & 12/09/2026 & Equipo FGMMN & Se atiende el item A4 de la rubrica de cierre: las 68 tablas pasan de anchos fijos en centimetros, que sumaban mas que la caja de texto de A4, a anchos proporcionales a ella, y se corrigen los parrafos que se salian del margen. El registro de compilacion queda sin ningun desborde horizontal ni vertical. No cambia el contenido de ningun requisito. \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.35\textwidth]{Firma_GS.png}
...
\begingroup
\small
\begin{longtable}{|P{0.3333}|P{0.3333}|P{0.3333}|}
\hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{Diagrama_Contexto.png}
...
\begingroup
\small
\begin{longtable}{|P{0.1667}|P{0.1667}|P{0.1667}|P{0.1667}|P{0.1667}|P{0.1667}|}
\hline
...
\begingroup
\small
\begin{longtable}{|P{0.2000}|P{0.2000}|P{0.2000}|P{0.2000}|P{0.2000}|}
\hline
...
\begingroup
\small
\begin{longtable}{|P{0.5000}|P{0.5000}|}
\hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{iStar_SD.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{iStar_SR.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{Mockup_Panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{Mockup_Alertas.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{Mockup_Mantenimiento.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{Mockup_Reportes.png}
...
Autenticación y control de roles & Gestionar acceso diferenciado. & Credenciales, rol, permisos, sesión, trazabilidad. & RF-19, RNF-03 \\ \hline
...
Entradas / Salidas & Entrada: lecturas de sensores ($^{\circ}$C, \%, presencia). Salida: registro con timestamp y aula\_id almacenado. \textbf{Depende de:} ninguno; es origen de datos del sistema. \textbf{Alimenta a:} RF-03, RF-05, RF-07, RF-08, RF-09, RF-14. \\ \hline
...
Entradas / Salidas & Entrada: comando (ON/OFF/ajuste), aula\_id, usuario autenticado. Salida: confirmación de ejecución o mensaje de error. \textbf{Depende de:} RF-13, RF-15, RF-16. \textbf{Alimenta a:} RF-04, RF-05, RF-07, RF-23. \\ \hline
...
Entradas / Salidas & Entrada: señal de sensor de presencia/movimiento. Salida: estado Ocupada/Vacía por aula en el panel. \textbf{Depende de:} RF-01. \textbf{Alimenta a:} RF-07, RF-13, RF-16, RF-20, RF-21. \\ \hline
...
Entradas / Salidas & Entrada: estado reportado por módulo de control. Salida: estado actualizado en panel + ejecución de comando. \textbf{Depende de:} RF-02. \textbf{Alimenta a:} RF-07, RF-23. \\ \hline
...
Entradas / Salidas & Entrada: lectura ambiental y valor objetivo de temperatura. Salida: confirmación de ajuste y estado actualizado. \textbf{Depende de:} RF-01, RF-02. \textbf{Alimenta a:} RF-07, RF-23. \\ \hline
...
Entradas / Salidas & Entrada: flujo de video o enlace RTSP/HTTP de cámara asociada. Salida: vista embebida dentro del panel. \textbf{Depende de:} ninguno; es origen de datos del sistema. \textbf{Alimenta a:} RF-07. \\ \hline
...
Entradas / Salidas & Entrada: datos consolidados de sensores, proyectores, climatización y conectividad. Salida: panel de control actualizado. \textbf{Depende de:} RF-01, RF-02, RF-03, RF-04, RF-05, RF-06, RF-09, RF-22. \textbf{Alimenta a:} ninguno; es punto de consumo final. \\ \hline
...
Entradas / Salidas & Entrada: evento de falla o lectura anómala. Salida: alerta con tipo, aula, prioridad, fecha/hora y responsable. \textbf{Depende de:} RF-01, RF-22. \textbf{Alimenta a:} RF-10, RF-11, RF-12. \\ \hline
...
Entradas / Salidas & Entrada: histórico de lecturas, fallas, uso y mantenimientos. Salida: indicador de riesgo (bajo/medio/alto) por equipo. \textbf{Depende de:} RF-01, RF-10. \textbf{Alimenta a:} RF-07, RF-12. \\ \hline
...
Entradas / Salidas & Entrada: datos del incidente, equipo afectado, responsable y acción realizada. Salida: registro persistente consultable. \textbf{Depende de:} RF-08, RF-12. \textbf{Alimenta a:} RF-09, RF-17. \\ \hline
...
Descripción & El sistema debe notificar de forma inmediata al \textbf{técnico asignado a la reparación}, y no solo al rol de mando, cuando una falla afecte una clase en curso o comprometa la disponibilidad de equipos esenciales. La notificación al rol de mando se mantiene como copia informativa; la que abre el plazo de atención es la dirigida al ejecutante. \\ \hline
Actor / Origen & Coordinadora de la Carrera-Docente (EV-02); deriva de RC-11 \\ \hline
Entradas / Salidas & Entrada: falla crítica, aula\_id, horario activo, equipo afectado. Salida: notificación dirigida al técnico asignado, con copia al rol de mando. \textbf{Depende de:} RF-08, RF-12. \textbf{Alimenta a:} RF-12. \\ \hline
...
Prioridad (MoSCoW) & Must \\ \hline
Criterio de verificación & Notificación generada en $\leq$30 s tras simulación de falla crítica durante horario activo, con el técnico asignado como destinatario principal verificable en el registro de envío. \\ \hline
...
Descripción & El sistema debe permitir que docentes y personal administrativo reporten incidencias y den seguimiento al estado de atención mediante tickets de mantenimiento. Cada ticket tiene asociado un \textbf{plazo máximo de primera respuesta según su prioridad}, parametrizable por la administración, y transita por \textbf{estados intermedios visibles para el solicitante}: recibido, en diagnóstico, en espera de repuesto, en espera de trámite externo, agendado, en proceso y cerrado. Los dos estados de espera exigen consignar la causa, y esa causa es visible para quien reportó. Vencido el plazo sin primera respuesta, el sistema escala el ticket al rol superior. \\ \hline
...
Entradas / Salidas & Entrada: formulario con aula, equipo, tipo de incidencia, prioridad y descripción; parámetros de plazo por prioridad configurados por la administración. Salida: ticket con ID, estado, causa de espera cuando corresponda, responsable y plazo comprometido; notificación al solicitante en cada cambio de estado, con el siguiente paso previsto. \textbf{Depende de:} RF-08, RF-09, RF-11. \textbf{Alimenta a:} RF-10, RF-11, RF-17, RF-23. \\ \hline
...
Prioridad (MoSCoW) & Must \\ \hline
Criterio de verificación & Ticket de prueba creado, consultado y con cambio de estado visible para roles autorizados. Configurado un plazo de prioridad alta, un ticket sin primera respuesta al vencerlo queda escalado y notificado. Un ticket puesto en espera de trámite externo muestra al solicitante el estado y su causa. \\ \hline
...
\begin{longtable}{|P{0.5000}|P{0.5000}|}
\hline
RF-13 - Apagado automático por regla de eficiencia energética & RF-13 - Apagado automático por regla de eficiencia energética \\ \hline
Descripción & El sistema debe apagar los equipos de un aula cuando registre consumo sostenido sin actividad detectada, con independencia del horario académico. La regla se evalúa de forma continua durante toda la jornada, incluidas las franjas que el horario asigna al aula. \\ \hline
Actor / Origen & Personal de Infraestructura y Mantenimiento (EV-01); deriva de RC-13. Delimitado frente a RF-16 por la solicitud de cambio SC-01 \\ \hline
Entradas / Salidas & Entrada: medida de consumo energético (RF-14), ocupación (RF-03), estado del equipo, umbral de la regla de eficiencia. Salida: comando de apagado y registro en bitácora (RF-23) con la causa \emph{eficiencia energética}. \textbf{Depende de:} RF-03. \textbf{Alimenta a:} RF-02, RF-14, RF-23. \\ \hline
Precondición / Postcondición & Regla de eficiencia activa para el aula; umbral de consumo sin actividad configurado. / Equipo apagado y evento auditado con su causa. \\ \hline
Prioridad (MoSCoW) & Must \\ \hline
Criterio de verificación & Con el aula sin actividad detectada y consumo por encima del umbral durante 5 minutos continuos \textbf{dentro} del horario académico asignado, el sistema ordena el apagado en $\leq$2 minutos y la bitácora registra RF-13 como regla de origen. \\ \hline
Regla de precedencia & Si las condiciones de RF-13 y RF-16 concurren sobre la misma aula, prevalece RF-16 por ser la de causa determinista. La bit\'acora (RF-23) consigna qu\'e regla orden\'o el apagado. Delimitaci\'on aprobada en la solicitud de cambio SC-01. \\ \hline
\caption{RF-13 - Apagado automático por regla de eficiencia energética}
\end{longtable}
\endgroup
...
Entradas / Salidas & Entrada: histórico de consumo por aula y equipo. Salida: reporte de patrones y lista de recomendaciones. \textbf{Depende de:} RF-01, RF-13. \textbf{Alimenta a:} RF-17. \\ \hline
...
Prioridad (MoSCoW) & Should \\ \hline
Criterio de verificación & Dadas dos aulas con perfiles de uso distintos, verificados por diferencia $\geq$20\,\% en horas de ocupación mensual, el sistema produce para cada una una recomendación que difiere de la otra en al menos un parámetro accionable (equipo, franja horaria o umbral). Dos evaluadores independientes verifican, sobre el histórico de consumo de cada aula, que cada parámetro recomendado se deriva de un dato de esa aula; el criterio se cumple cuando ambos coinciden en el 100\,\% de los parámetros. \\ \hline
...
Entradas / Salidas & Entrada: horario académico, aula\_id, equipo\_id, reglas. Salida: ejecución automática de comandos según programación. \textbf{Depende de:} ninguno; es origen de datos del sistema. \textbf{Alimenta a:} RF-02, RF-16, RF-17, RF-21. \\ \hline
...
\begin{longtable}{|P{0.5000}|P{0.5000}|}
\hline
RF-16 - Apagado automático por fin de horario académico & RF-16 - Apagado automático por fin de horario académico \\ \hline
Descripción & El sistema debe apagar todos los equipos compatibles de un aula al concluir la última franja que el horario académico le asigna en la jornada, con independencia del consumo registrado. \\ \hline
Actor / Origen & Personal de Infraestructura y Mantenimiento (EV-01); deriva de RC-16. Delimitado frente a RF-13 por la solicitud de cambio SC-01 \\ \hline
Entradas / Salidas & Entrada: horario académico vigente (RF-15), ocupación (RF-03), estado de equipos, aula\_id. Salida: apagado total y registro en bitácora (RF-23) con la causa \emph{fin de horario}. \textbf{Depende de:} RF-03, RF-15. \textbf{Alimenta a:} RF-02, RF-23. \\ \hline
Precondición / Postcondición & Horario vigente cargado; última franja asignada al aula concluida. / Todos los equipos compatibles apagados y evento auditado con su causa. \\ \hline
Prioridad (MoSCoW) & Must \\ \hline
Criterio de verificación & Transcurrida la última franja asignada y confirmada la desocupación por sensor, el sistema ordena el apagado total en $\leq$2 minutos y la bitácora registra RF-16 como regla de origen. \\ \hline
Regla de precedencia & Si las condiciones de RF-13 y RF-16 concurren sobre la misma aula, prevalece RF-16 por ser la de causa determinista. La bit\'acora (RF-23) consigna qu\'e regla orden\'o el apagado. Delimitaci\'on aprobada en la solicitud de cambio SC-01. \\ \hline
\caption{RF-16 - Apagado automático por fin de horario académico}
\end{longtable}
\endgroup
...
Entradas / Salidas & Entrada: rango de fechas, aula, tipo de reporte, datos históricos. Salida: reporte estadístico generado en la plataforma. \textbf{Depende de:} RF-10, RF-12, RF-14, RF-15, RF-20. \textbf{Alimenta a:} RF-18. \\ \hline
...
Entradas / Salidas & Entrada: reporte generado, formato seleccionado (PDF/Excel). Salida: archivo exportado disponible para descarga. \textbf{Depende de:} RF-17. \textbf{Alimenta a:} RF-23. \\ \hline
...
Entradas / Salidas & Entrada: credenciales, rol asignado, solicitud de operación. Salida: acceso permitido o denegado según permisos. \textbf{Dependencia transversal:} RF-19 condiciona el acceso a toda operaci\'on del sistema. Esa relaci\'on se declara en la precondici\'on de cada ficha y no como flujo de datos, para no contar dos veces el mismo acoplamiento. \\ \hline
...
Entradas / Salidas & Entrada: datos de sensores, aula\_id, horario vigente. Salida: historial de ocupación consultable por aula y periodo. \textbf{Depende de:} RF-03. \textbf{Alimenta a:} RF-17. \\ \hline
...
Entradas / Salidas & Entrada: estado del equipo, horario, aula\_id. Salida: notificación enviada al responsable correspondiente. \textbf{Depende de:} RF-03, RF-15. \textbf{Alimenta a:} RF-23. \\ \hline
...
Entradas / Salidas & Entrada: estado de conexión, tiempo de respuesta, ID de dispositivo. Salida: estado de conectividad y alerta si hay pérdida. \textbf{Depende de:} ninguno; es origen de datos del sistema. \textbf{Alimenta a:} RF-07, RF-08. \\ \hline
...
Entradas / Salidas & Entrada: usuario, rol, acción, fecha/hora, módulo, resultado. Salida: registro de bitácora consultable por usuarios autorizados. \textbf{Depende de:} RF-02, RF-04, RF-05, RF-12, RF-13, RF-16, RF-18, RF-21, RF-25. \textbf{Alimenta a:} RF-24. \\ \hline
...
Entradas / Salidas & Entrada: solicitud de exportación del usuario autenticado. Salida: archivo con los datos personales del usuario en formato legible. \textbf{Depende de:} RF-23. \textbf{Alimenta a:} ninguno; es punto de consumo final. \\ \hline
...
Entradas / Salidas & Entrada: solicitud de corrección con el campo y valor propuesto. Salida: dato actualizado y evento registrado en bitácora. \textbf{Depende de:} ninguno; es origen de datos del sistema. \textbf{Alimenta a:} RF-23. \\ \hline
...
\begingroup
\small
\begin{longtable}{|P{0.1635}|P{0.3396}|P{0.1509}|P{0.1635}|P{0.1824}|}
\hline
ID & Descripción cuantificada & Característica ISO 25010 & Criterio de verificación & Estado de validación \\ \hline
RNF-01 & El sistema debe entregar alertas de anomalía en $\leq$60 s desde la detección. & Eficiencia de desempeño & Prueba de carga con 50 aulas simuladas; medición del tiempo real de entrega. & Validado en 1B \\ \hline
RNF-02 & Disponibilidad $\geq$99 \% mensual (downtime $\leq$7,3 h/mes). & Fiabilidad & Monitoreo de uptime durante 30 días continuos. & Validado en 1B \\ \hline
RNF-03 & Datos en tránsito y reposo cifrados con AES-256; acceso sin credenciales rechazado en el 100 \% de los casos. & Seguridad & Auditoría de cifrado + intento de acceso sin credenciales rechazado en todos los casos. & Validado en 1B \\ \hline
RNF-04 & Usuario sin capacitación previa completa 'consultar estado de un aula' en $\leq$5 min. \textit{Corregido contra evidencia de campo: el umbral anterior de 2 min se fijo sin consultar a ningun usuario; el unico participante al que se le pregunto (EV-24) declaro un maximo de cinco minutos.} & Interacción de usuario & Prueba de usabilidad con $\geq$3 usuarios reales, medición del tiempo de tarea. & Validado en 1B \\ \hline
RNF-05 & La interfaz debe funcionar sin instalación adicional en Chrome, Firefox y Edge, en resoluciones de 360px a 1920px. & Portabilidad / Compatibilidad & Prueba cruzada en 3 navegadores y 2 tamaños de pantalla. & Validado en 1B \\ \hline
RNF-06 & Cobertura de pruebas unitarias $\geq$70 \% en módulos críticos (alertas y control remoto). & Mantenibilidad & Reporte de cobertura generado por la herramienta de testing del proyecto. & Validado en 1B \\ \hline
...
RNF-16 & Disponibilidad en modo degradado sin conectividad: el sistema debe notificar explícitamente al usuario cuando un aula no tiene conectividad de red disponible, en lugar de fallar silenciosamente o mostrar datos obsoletos sin advertencia. & Fiabilidad & Prueba de desconexión total de red en un aula piloto; verificación de que el sistema muestra un aviso explícito de falta de conectividad al usuario. & \textbf{Sustentado en evidencia de campo} --- DOC-02 (EV-13) señaló la necesidad de que el sistema opere sin conexión a internet, y COORD-03 (EV-14) confirmó fallas recurrentes de internet que afectan el acceso al sistema; ambos testimonios, independientes entre sí, formalizan RNF-16. Umbral de tiempo de respuesta del aviso no cuantificado en esta entrega \\ \hline
...
\subsubsection*{3.3.2 Requisitos del componente de inteligencia artificial}

\addcontentsline{toc}{subsubsection}{3.3.2 Requisitos del componente de inteligencia artificial}

SIGA contiene un \textbf{unico componente basado en aprendizaje automatico}: RF-09,
analisis predictivo de fallos de equipamiento. RF-03, la deteccion de ocupacion, no lo es
con la especificacion vigente: es un umbral determinista sobre la senal de un sensor de
presencia, sin parametros aprendidos.

La ficha completa del componente, con la justificacion de cada umbral y su metodo de
comprobacion, esta en \nolinkurl{01_ERS/Componentes_IA/ficha_RF-09_analisis_predictivo_fallos.md},
y la clasificacion de riesgo razonada en
\nolinkurl{01_ERS/Componentes_IA/clasificacion_riesgo_ia.md}. Lo que sigue es su resumen
normativo, para que la especificacion no dependa de un anexo externo.

\medskip
\noindent\textbf{a) Rendimiento y correccion.} Cuatro requisitos funcionales del
componente y cuatro de rendimiento, todos con umbral, unidad y metodo: sensibilidad
$\geq$70 \%, falsos positivos $\leq$30 \%, cobertura de equipos elegibles del 100 \%,
error de calibracion esperado $\leq$0,10; inferencia del parque completo $\leq$120 s,
latencia de consulta $\leq$2 s, una ejecucion cada 24 h y $\leq$512 MB de memoria
residente. Todos se comprueban sobre un conjunto de prueba separado \textbf{de forma
temporal}, no aleatoria, para no filtrar informacion del futuro hacia el entrenamiento.

\medskip
\noindent\textbf{b) Equidad.} El componente no decide sobre personas, pero \textbf{si
reparte un recurso escaso}: la atencion del personal de mantenimiento. Un modelo que
prediga peor en un bloque haria que esas aulas reciban menos mantenimiento preventivo, y
quien lo sufre es quien da clase alli. Se especifican tres requisitos: la sensibilidad no
debe depender del bloque edilicio ni la tasa de falsos negativos de la antiguedad del
equipo, con brecha maxima de \textbf{10 puntos porcentuales} en ambos casos; y la
cobertura de prediccion debe ser pareja entre aulas de alta y baja ocupacion, con brecha
maxima de \textbf{5 puntos}. Cada brecha se reporta con intervalo de confianza al 95 \%
por bootstrap. \textbf{Si alguna se supera, el componente no se despliega}: se reentrena
con muestreo balanceado y se vuelve a medir.

\medskip
\noindent\textbf{c) Explicabilidad.} Formalizada como RNF-10 y detallada en la
Seccion 3.3.1: explicacion causal de las tres variables que mas contribuyeron, en lenguaje
llano, \textbf{60 palabras como maximo} y en \textbf{$\leq$2 s}, con comprension validada
por al menos 4 de cada 5 participantes no tecnicos. Se declara su limitacion en el propio
panel: el metodo atribuye peso por variable, \textbf{no establece causalidad}.

\medskip
\noindent\textbf{d) Datos de entrenamiento.} Solo datos propios del despliegue; ningun
conjunto externo ni preentrenado. Volumen minimo de 30 dias por equipo y 40 eventos de
falla etiquetados; por debajo, el componente no se entrena y el sistema opera sin RF-09.
El etiquetado es automatico y derivado del registro operativo. Se declaran cuatro sesgos
conocidos --- de reporte, de cobertura, de mantenimiento previo y desbalance de clases ---
con su mitigacion. El unico campo personal, el responsable del registro de mantenimiento,
\textbf{se excluye del entrenamiento}.

\medskip
\noindent\textbf{e) Plan de monitoreo en operacion.} Seis indicadores con su frecuencia,
umbral de alerta y accion: sensibilidad movil, tasa de falsos positivos, deriva de las
entradas, cobertura, brechas de equidad y volumen de datos nuevos. El reentrenamiento se
dispara al acumularse 40 eventos nuevos, al caer la sensibilidad por debajo del 60 \%, al
detectarse deriva superior a 0,25 o a los 12 meses del ultimo entrenamiento. Todo
reentrenamiento repite integramente las comprobaciones de rendimiento y equidad antes de
sustituir al modelo; \textbf{el que no las supera no se despliega}, y sigue operando el
anterior.

\medskip
\noindent\textbf{f) Clasificacion de riesgo y base legal.} El sistema se clasifica como
de \textbf{riesgo minimo} conforme al Reglamento (UE) 2024/1689, tras descartar una a una
las cuatro hipotesis de alto riesgo educativo de su Anexo III: el componente no evalua
personas, no asigna calificaciones, no admite ni orienta admisiones y no vigila el
comportamiento de estudiantes. El tratamiento de datos personales se rige por la Ley
Organica de Proteccion de Datos Personales del Ecuador, con base legal en el cumplimiento
de una mision de interes publico de la institucion.

\medskip
\noindent\textbf{g) Trazado.} Los requisitos del componente no quedan aislados:
\nolinkurl{01_ERS/Componentes_IA/trazado_requisitos_ia.csv} enlaza cada uno con los
requisitos preexistentes del sistema y declara la naturaleza de la relacion.

\subsubsection*{3.3.3 Requisitos no funcionales del componente inteligente}

\addcontentsline{toc}{subsubsection}{3.3.3 Requisitos no funcionales del componente inteligente}

Los apartados anteriores describen el componente de inteligencia artificial. Esta subsección lo especifica: convierte cada uno de sus aspectos en un requisito no funcional con identificador propio, enunciado verificable, métrica, unidad, umbral, método de verificación, responsable y frecuencia de medición. La distinción no es formal. Un concepto nombrado en el texto no se puede comprobar; un requisito con umbral y método, sí.

Ocho requisitos, \textbf{RNF-IA-01} a \textbf{RNF-IA-08}, cubren los seis aspectos exigibles: predicción de uso de aulas, explicabilidad, equidad, supervisión humana sobre las acciones automáticas, monitoreo posterior al despliegue y clasificación del nivel de riesgo. Los ocho constan en \nolinkurl{01_ERS/Componentes_IA/requisitos_no_funcionales_ia.csv} con sus atributos completos, y \textbf{los ocho figuran en la matriz de trazabilidad}, cada uno vinculado al elemento de diseño que lo realiza y al caso de prueba que lo verifica.

Dos de ellos son nuevos y conviene señalarlo. \textbf{RNF-IA-06} exige que ninguna acción automática sobre el equipamiento sea irreversible: hasta ahora RF-16 y RNF-16 cubrían el apagado automático y su notificación, pero ningún requisito obligaba a que la acción se pudiera deshacer ni fijaba una ventana para hacerlo. \textbf{RNF-IA-05} vigila que la atención de las solicitudes no dependa de quién las emite, agrupando a los docentes por volumen de reportes y no por persona, porque construir un perfil individual de cada docente sería justamente lo que RD-09 impide.

\begingroup
\footnotesize
\begin{longtable}{|p{1.6cm}|p{4.4cm}|p{2.5cm}|p{2.2cm}|p{2.6cm}|}
\hline
\textbf{ID} & \textbf{Enunciado verificable} & \textbf{Métrica y unidad} & \textbf{Umbral} & \textbf{Responsable y frecuencia} \\ \hline
\endfirsthead
\hline
\textbf{ID} & \textbf{Enunciado verificable} & \textbf{Métrica y unidad} & \textbf{Umbral} & \textbf{Responsable y frecuencia} \\ \hline
\endhead
RNF-IA-01 & El modulo de deteccion de ocupacion debe coincidir con el estado real del aula, comprobado por verificacion presencial, en al menos 95 de cada 100 comprobaciones. & Tasa de acierto de la deteccion de ocupacion frente a verificacion presencial (porcentaje de comprobaciones coincidentes) & $\geq$ 95 & Personal de Infraestructura y Mantenimiento, con validacion del analista lider. Mensual durante los tres primeros meses de operacion; trimestral despues \\ \hline
RNF-IA-02 & La prediccion de ocupacion de un aula para una franja horaria futura no debe desviarse del uso realmente observado en mas de diez puntos porcentuales, medida sobre semanas retenidas que el modelo no vio al ajustarse. & Error absoluto medio entre la ocupacion prevista y la observada, por aula y franja (puntos porcentuales de ocupacion) & $\leq$ 10 & Analista lider. Trimestral, y ademas cada vez que se reajuste el modelo \\ \hline
RNF-IA-03 & Toda prediccion de falla mostrada al usuario debe ir acompanada de una explicacion que nombre las tres senales que mas pesaron en ella y el sentido en que lo hicieron, en lenguaje sin terminologia estadistica, en un maximo de 60... & Tres medidas conjuntas: longitud de la explicacion, latencia hasta mostrarla, y proporcion de personas destinatarias que, tras leerla, dicen correctamente que accion tomarian (palabras; segundos; porcentaje de comprension correcta) & $\leq$ 60 palabras; $\leq$ 2 segundos en el percentil 95; $\geq$ 80 \% de comprension & Analista lider para las dos primeras; Docente y Personal de Infraestructura y Mantenimiento como panel para la tercera. Las dos automaticas, en cada version que toque el modelo o la interfaz. La de comprension, semestral \\ \hline
RNF-IA-04 & La cobertura del mantenimiento preventivo que dispara el componente no debe diferir en mas de cinco puntos porcentuales entre las carreras que comparten el edificio, ni entre las franjas de manana, tarde y noche. & Diferencia maxima de cobertura entre grupos, tomando como grupos las carreras y las franjas horarias por separado (puntos porcentuales de diferencia de cobertura) & $\leq$ 5 & Coordinacion, con el calculo a cargo del analista lider. Trimestral \\ \hline
RNF-IA-05 & La probabilidad de que una solicitud de mantenimiento sea atendida dentro del plazo comprometido no debe depender de que docente la origino: la diferencia entre el docente mejor y el peor atendido, agrupando por volumen de reportes, no... & Diferencia de tasa de atencion en plazo entre grupos de docentes formados por volumen de reportes (puntos porcentuales de diferencia) & $\leq$ 10 & Coordinacion. Semestral \\ \hline
RNF-IA-06 & Toda accion que el sistema ejecute sobre el equipamiento de un aula sin intervencion humana debe quedar registrada con el criterio que la disparo, ser reversible por una persona autorizada durante los quince minutos siguientes, y... & Tres medidas: proporcion de acciones automaticas registradas con su criterio, proporcion notificadas en el momento, y proporcion reversibles dentro de la ventana (porcentaje de acciones automaticas) & 100 en las tres; una sola accion sin registro, sin aviso o irreversible incumple el requisito & Personal de TI, con revision de Coordinacion. Continua por auditoria automatica; revision documentada mensual \\ \hline
RNF-IA-07 & El sistema debe mantener en operacion el plan de monitoreo del componente inteligente, de modo que cada uno de sus indicadores se calcule con la periodicidad declarada, tenga un responsable nombrado y dispare aviso al superar su umbral... & Proporcion de ciclos de medicion ejecutados y registrados sobre los ciclos previstos por el plan (porcentaje de ciclos cumplidos) & $\geq$ 95, y ningun indicador con dos ciclos consecutivos sin medir & Personal de TI como ejecutor; Coordinacion como responsable de que el plan se cumpla. Revision trimestral del cumplimiento del propio plan \\ \hline
RNF-IA-08 & La clasificacion del nivel de riesgo del componente inteligente debe estar documentada con su justificacion, revisarse al menos una vez al ano y ademas cada vez que cambie el alcance de las decisiones automaticas o las categorias de... & Antiguedad de la revision vigente, y proporcion de cambios de alcance que provocaron una revision (meses desde la ultima revision; porcentaje de cambios de alcance revisados) & $\leq$ 12 meses; 100 \% de los cambios de alcance & Analista lider, con aprobacion de Coordinacion. Anual, y ante cada cambio de alcance \\ \hline
\caption{Requisitos no funcionales del componente inteligente}
\end{longtable}
\endgroup

\noindent\textbf{Estado de verificación.} Ninguno de los ocho está verificado con medición sobre un sistema en operación, porque el sistema no está desplegado. Se declara así, requisito por requisito, en la columna correspondiente del archivo de datos, en lugar de presentar umbrales de análisis como si fueran resultados. RNF-IA-02 va más lejos y declara que el prototipo ni siquiera implementa todavía el modelo predictivo de uso: registra el historial de ocupación que ese modelo necesitará.

\noindent\textbf{Plan de monitoreo.} RNF-IA-07 obliga a mantener en operación el plan de \nolinkurl{01_ERS/Componentes_IA/plan_monitoreo_postdespliegue.md}, que desarrolla once indicadores con su periodicidad, su responsable, su umbral de alerta y \textbf{la acción concreta que se toma al superarlo}. Un indicador sin acción declarada no es un indicador, es una cifra.


\subsubsection*{3.3.4 Método del cruce de RNF-07 a RNF-16 contra la evidencia de campo}

\addcontentsline{toc}{subsubsection}{3.3.4 Método del cruce de RNF-07 a RNF-16 contra la evidencia de campo}
...
Protección de datos desde el diseño & Medidas técnicas y organizativas desde el diseño del sistema. & RNF-03, RD-10 & Cifrado AES-256 y control de acceso por roles definidos desde la arquitectura. \\ \hline
...
RD-06 & Tecnológica & La interfaz de usuario deberá ejecutarse en navegadores modernos sin requerir instalación adicional en los equipos de los usuarios. & El acceso web facilita el uso por parte de docentes, personal administrativo, autoridades, TI e Infraestructura sin depender de software local. & RF-07, RF-08, RF-12, RF-17, RF-18, RNF-05 \\ \hline
...
RD-15 & Temporal & Para la Entrega 4 (2B) se completará el manuscrito de publicación, el dataset FAIR en Zenodo y el cierre de la evidencia de campo hasta 24 participantes. & La Entrega 3 (2A) produjo los datos empíricos que esta entrega analiza y reportará en el manuscrito paralelo. & RF-01 a RF-25, RNF-01 a RNF-16 \\ \hline
...
\textbf{CA-01.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que sensor configurado y conectado a la red del aula, cuando se cumple la condición operativa de RF-01, entonces prueba de inyección de lectura simulada $\rightarrow$ dato visible en panel en $\leq$10 s; margen de error $\leq$1 }\textit{$^{\circ}$c}\textit{ / $\leq$5 \% humedad.}
...
\textbf{CA-02.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que usuario autenticado con rol autorizado; dispositivo en línea, cuando se cumple la condición operativa de RF-02, entonces comando enviado se ejecuta en el dispositivo en $\leq$5 s, con registro en bitácora.}
...
\textbf{CA-03.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que sensor de presencia instalado y calibrado, cuando se cumple la condición operativa de RF-03, entonces exactitud $\geq$95 \% y latencia $\leq$15 s en pruebas controladas de entrada/salida de personas.}
...
\textbf{CA-04.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que proyector conectado al módulo de control }\textit{iot}\textit{, cuando se cumple la condición operativa de RF-04, entonces cambio de estado del proyector reflejado en panel en $\leq$10 s.}
...
\textbf{CA-05.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que equipo de climatización conectado a controlador remoto compatible, cuando se cumple la condición operativa de RF-05, entonces ajuste remoto reflejado en equipo físico o controlador en $\leq$15 s.}
...
\textbf{CA-06.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que usuario autenticado con permisos de visualización, cuando se cumple la condición operativa de RF-07, entonces panel actualiza datos automáticamente cada $\leq$30 s para $\geq$1 aula de prueba.}
...
\textbf{CA-07.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que reglas de anomalía y destinatarios configurados, cuando se cumple la condición operativa de RF-08, entonces falla simulada genera alerta entregada al responsable en $\leq$1 minuto.}
...
\textbf{CA-08.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que incidente generado por rf-08 o reportado vía rf-12, cuando se cumple la condición operativa de RF-10, entonces todo incidente cerrado consultable con los 5 campos mínimos completos (fecha, hora, tipo, equipo, responsable).}
...
\textbf{CA-09.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que horario académico cargado; falla detectada durante clase programada, cuando se cumple la condición operativa de RF-11, entonces notificación generada en $\leq$30 s tras simulación de falla crítica durante horario activo.}
...
\textbf{CA-10.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que usuario autenticado con rol docente, administrativo o técnico, cuando se cumple la condición operativa de RF-12, entonces }\textit{ticket}\textit{ de prueba creado, consultado y con cambio de estado visible para roles autorizados.}
...
\textbf{CA-11.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que la regla de eficiencia está activa para el aula y el umbral de consumo sin actividad está configurado, cuando el aula registra consumo por encima del umbral durante 5 minutos continuos sin actividad detectada, entonces el sistema ordena el apagado en $\leq$2 minutos y la bitácora registra RF-13 como regla de origen.}
...
\textbf{CA-12.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que horario académico cargado, vigente y asociado a las aulas, cuando se cumple la condición operativa de RF-15, entonces regla programada ejecutada con tolerancia $\leq$±1 minuto respecto al horario definido.}
...
\textbf{CA-13.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que el horario vigente está cargado y la última franja asignada al aula ha concluido, cuando el sensor confirma que el aula está desocupada, entonces el sistema ordena el apagado total en $\leq$2 minutos y la bitácora registra RF-16 como regla de origen.}
...
\textbf{CA-14.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que usuario registrado con rol asignado, cuando se cumple la condición operativa de RF-19, entonces usuario con rol docente no puede acceder a funciones administrativas ni técnicas reservadas a otros roles.}
...
\textbf{CA-15.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que horario académico cargado; equipo reporta su estado operativo, cuando se cumple la condición operativa de RF-21, entonces equipo encendido fuera de horario por el tiempo configurado genera notificación en $\leq$60 s.}
...
\textbf{CA-16.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que dispositivo }\textit{iot}\textit{ registrado y asociado a un aula, cuando se cumple la condición operativa de RF-22, entonces desconexión simulada de sensor muestra 'sin conexión' y genera alerta al responsable en $\leq$60 s.}
...
\textbf{CA-17.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que usuario autenticado ejecuta una acción en la plataforma, cuando se cumple la condición operativa de RF-23, entonces acciones de control, }\textit{ticket}\textit{ y exportación de reporte quedan registradas con todos los campos mínimos.}
...
\subsubsection*{HU-18 (RF-20)}

\addcontentsline{toc}{subsubsection}{HU-18 (RF-20)}

Como Coordinadora de la Carrera, quiero consultar el historial de ocupacion de cada aula con su fecha, hora de inicio, hora de fin y duracion, para saber que aulas se usan de verdad y cuales estan asignadas pero vacias.


\textbf{CA-18.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que el sensor de ocupacion del aula esta instalado y conectado, cuando se producen cambios de ocupacion a lo largo de una jornada, entonces cada cambio queda registrado con fecha, hora, estado y duracion, y el historial resultante es consultable por aula y por periodo.}

\subsubsection*{HU-19 (RF-24)}

\addcontentsline{toc}{subsubsection}{HU-19 (RF-24)}

Como usuario del sistema, quiero exportar los datos personales que el sistema guarda sobre mi, para ejercer el derecho de acceso que me reconoce el articulo 13 de la Ley Organica de Proteccion de Datos Personales.


\textbf{CA-19.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que el usuario esta autenticado, cuando solicita la exportacion de sus datos personales, entonces el sistema genera un archivo descargable en formato legible con los campos de su perfil y las entradas de bitacora asociadas a el, y lo pone a disposicion en un plazo maximo de 15 dias habiles.}

\subsubsection*{HU-20 (RF-25)}

\addcontentsline{toc}{subsubsection}{HU-20 (RF-25)}

Como usuario del sistema, quiero solicitar la correccion de un dato personal mio que sea inexacto, para ejercer el derecho de rectificacion que me reconoce el articulo 14 de la Ley Organica de Proteccion de Datos Personales.


\textbf{CA-20.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que el usuario esta autenticado y el dato esta identificado como propio, cuando solicita su correccion indicando el campo y el valor propuesto, entonces el sistema refleja el cambio en un plazo maximo de 15 dias habiles y registra el evento en la bitacora de acciones, con el valor anterior y el nuevo.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{usecase_general.png}
...
Requisitos relacionados & RF-19, RF-23, RNF-03 \\ \hline
...
Requisitos relacionados & RF-06, RNF-03 \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{class_diagram_refined.png}
...
{\sloppy \textit{Secuencia CU-04 (Generar alertas): }\textit{SensorIoT}\textit{ $\rightarrow$ }\textit{GatewayIoT}\textit{ $\rightarrow$ }\textit{SIGA.evaluarRegla}\textit{() $\rightarrow$ }\textit{SIGA.crearAlerta}\textit{() $\rightarrow$ }\textit{ServicioNotificaciones.enviar}\textit{() $\rightarrow$ }\textit{PersonalInfraestructura.recibirAlerta}\textit{().}\par}


{\sloppy \textit{Secuencia CU-06 (Registrar solicitud de mantenimiento): Docente $\rightarrow$ }\textit{SIGA.mostrarFormulario}\textit{() $\rightarrow$ }\textit{Docente.enviarSolicitud}\textit{() $\rightarrow$ }\textit{SIGA.validarCampos}\textit{() $\rightarrow$ }\textit{SIGA.generarTicket}\textit{() $\rightarrow$ }\textit{BitacoraAccion.registrar}\textit{().}\par}


{\sloppy \textit{Secuencia CU-16 (Predecir fallas, RF-09): }\textit{PersonalInfraestructura}\textit{ $\rightarrow$ }\textit{SIGA.solicitarAnalisis}\textit{() $\rightarrow$ }\textit{SIGA.consultarHistorico}\textit{() $\rightarrow$ }\textit{ModuloIA.procesarDatos}\textit{() $\rightarrow$ }\textit{ModuloIA.generarIndicadorRiesgo}\textit{() $\rightarrow$ }\textit{ModuloIA.generarExplicacion}\textit{() [RNF-10] $\rightarrow$ }\textit{SIGA.mostrarResultado}\textit{().}\par}


\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC04_generate_anomaly_alerts.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC06_register_maintenance_request.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC16_predict_equipment_failures.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC05_attend_anomaly_alert.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC07_track_maintenance_ticket.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{state_maintenance_request.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{component_diagram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{deployment_diagram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC01_monitor_room_status.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC02_remote_equipment_control.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC03_detect_room_occupancy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC05_attend_anomaly_alert.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC07_track_maintenance_ticket.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC08_view_failure_maintenance_history.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC09_generate_administrative_reports.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC10_export_reports.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC11_manage_users_roles_permissions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC12_monitor_iot_connectivity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC13_schedule_automatic_onoff_rules.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC14_log_user_actions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{seq_UC15_view_room_cameras.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC01_monitor_room_status.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC02_remote_equipment_control.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC03_detect_room_occupancy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC04_generate_anomaly_alerts.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC06_register_maintenance_request.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC08_view_failure_maintenance_history.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC09_generate_administrative_reports.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC10_export_reports.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC11_manage_users_roles_permissions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC12_monitor_iot_connectivity.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC13_schedule_automatic_onoff_rules.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC14_log_user_actions.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC15_view_room_cameras.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{act_UC16_predict_equipment_failures.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,height=0.8\textheight,keepaspectratio]{state_alert.png}
\caption{Diagrama de estados --- Alerta}
\label{fig:state-alerta}
\end{figure}

\subsubsection*{HU-21 (RF-12)}

\addcontentsline{toc}{subsubsection}{HU-21 (RF-12)}

Como Coordinadora de la Carrera, quiero que cada solicitud de mantenimiento tenga un plazo
de primera respuesta segun su prioridad y que se me informe del estado en que se encuentra
y de la causa cuando esta detenida, para saber a que atenerme en lugar de suponer que se
olvidaron de mi caso.


\textbf{CA-21.} \textit{Escenario }\textit{Gherkin}\textit{ --- Dado que la administracion
ha configurado un plazo de primera respuesta para la prioridad alta, cuando se registra una
solicitud con esa prioridad y el plazo vence sin primera respuesta, entonces el sistema
escala la solicitud al rol superior y lo notifica; y dado que una solicitud queda en espera
de tramite externo, cuando el solicitante la consulta, entonces ve el estado y la causa de
la espera.}
...
RNF-01 & Alertas en $\leq$60 s & RNF & Must & --- & Tiempo de respuesta crítico para alertas útiles durante una clase en curso. \\ \hline
RNF-02 & Disponibilidad $\geq$99 \% mensual & RNF & Must & --- & El sistema debe operar continuamente. \\ \hline
RNF-03 & Cifrado AES-256 y autenticación & RNF & Must & --- & Requisito de seguridad fundamental para el despliegue institucional. \\ \hline
RNF-10 & Explicabilidad de RF-09 & RNF & Must & --- & Gatekeeper G7: obligatorio para todo componente de IA/ML del sistema. \\ \hline
...
Enfoque 1: comparación de la calidad de los Requisitos Funcionales elicitados por el equipo humano frente a los generados por un Modelo Grande de Lenguaje (LLM) a partir de un material fuente compartido: el corpus anonimizado de entrevistas de campo. El Conjunto A (LLM) se generó sobre el corpus completo de las 11 entrevistas recolectadas (EV-01, EV-02, EV-08 a EV-16); el Conjunto B (humano) se elicitó sobre las 10 entrevistas que permanecen válidas tras excluir EV-15 por retiro de consentimiento informado (ver Sección 3.3 y Apéndice B.1). Esta asimetría de corpus entre ambos conjuntos se declara explícitamente como amenaza a la validez de constructo en el manuscrito (07\_Publicacion/manuscrito\_final.tex, sección de amenazas a la validez).
...
Intervención & Elicitación asistida por modelo de lenguaje grande (Claude Sonnet 5, interfaz de chat), a partir del corpus completo de las 11 entrevistas anonimizadas recolectadas (EV-01, EV-02, EV-08 a EV-16). \\ \hline
Comparación & RF elicitados por el equipo humano (Sección 3.2) a partir de las 10 entrevistas que permanecen válidas tras excluir EV-15 (retiro de consentimiento). \\ \hline
...
Se declara como limitación de validez de constructo que el modelo utilizado para generar el Conjunto A tuvo exposición previa parcial al Conjunto B (RF humanos) en sesiones de chat anteriores dentro de la misma cuenta, por lo que no constituye una instancia ``ingenua'' en el sentido estricto de un diseño experimental limpio (detalle completo en \nolinkurl{06_Experimento/prompts_llm/prompt_llm_conjunto_A.md}).
...
La Entrega Final (2B) del Proyecto Fin de Curso consolida y amplía la especificación construida en la Entrega 3 (2A) y, antes, en la Entrega 2 (1B) del Sistema Inteligente de Gestión de Aulas (SIGA), siguiendo la estructura del estándar IEEE/ISO/IEC 29148:2018 y elevando el estándar de exigencia hacia una ERS/SRS completa con componente empírico.
...
Analista líder & SÁNCHEZ CORNEJO, GARY ALBERTO & Coordina, valida con el cliente, redacta requisitos, gestiona el repositorio, registra el protocolo en OSF. \\ \hline
Modelador & SÁNCHEZ CORNEJO, GARY ALBERTO & Construye los diagramas UML completos y el modelado i*. \\ \hline
Documentador & MUÑOZ QUIÑÓNEZ, YERANICK ESTHER & Estructura el ERS según IEEE 29148, glosario, referencias y manuscrito paralelo. \\ \hline
Verificador & MUÑOZ QUIÑÓNEZ, YERANICK ESTHER & Controla calidad: verificabilidad, consistencia, no ambigüedad, completitud y checklist de gatekeepers; mantiene la matriz de trazabilidad. \\ \hline
Transcriptor & CEDEÑO ÁVILA, WINSTON DAMIÁN & Transcribe y anonimiza el corpus de entrevistas de la ronda terminal, aplicando el procedimiento de disociación declarado. \\ \hline
\caption{Roles del equipo}
\end{longtable}
\endgroup

\noindent\textbf{Composición del equipo.} La Entrega Final, tal como se calificó, la sostuvieron \textbf{dos integrantes}, que se repartieron los cuatro primeros roles del plan. El 2 de septiembre de 2026 se reincorpora un tercero, CEDEÑO ÁVILA, WINSTON DAMIÁN, que asume la transcripción y anonimización del corpus de la ronda terminal de campo; MENDOZA PALMA, ALLAN JEREMY, que figuraba en la carátula del Sistema de Gestión Académica, se retiró del equipo sin producir artefactos ni confirmaciones en el repositorio. La composición vigente, con la fecha de cada alta y baja y su comprobación contra el historial, consta en \nolinkurl{04_Trazabilidad/composicion_equipo.md}, y el cambio queda registrado en la bitácora de desviaciones. Ningún apartado de este documento procede de un integrante que ya no forma parte del equipo.
...
7-8 & Ampliación a RF-17 a RF-23. RNF-01 a RNF-06. Restricciones. Mockups Figma. & Sección 3.2, 3.3, 3.4, mockups & $\checkmark$ \\ \hline
...
14-15 & Modelado UML completo (8 diagramas + i*), Kano, WSJF, MVP. & Diagramas, priorización, MVP & Completado \\ \hline
16 & Análisis del componente empírico, dataset Zenodo. & Dataset con DOI & Completado \\ \hline
17 & Entrega 4 (2B) y defensa final. & Manuscrito completo, defensa oral & Manuscrito completado; defensa en la semana 19 \\ \hline
...
EV-07 & Documento institucional & 02/07/2026 & Evidencia del sistema de cámaras/\allowbreak video\-vigi\-lancia & RF-06, RF-07, RF-22; RD-05 & N/A \\ \hline
...
EV-15 & Entrevista + Audio (sin video, a petición del participante) & 29/07/2026 & Docente de la Facultad --- DOC-03 & \textbf{Ninguno} --- entrevista realizada pero \textbf{excluida íntegramente del corpus de evidencia} por retiro del consentimiento informado, confirmado el 13/08/2026; RNF-16 y RD-02, originalmente asociados a esta evidencia, se re-fun\-da\-men\-ta\-ron en EV-13 y EV-14 & \textbf{N} --- el participante no firmó el consentimiento informado, ni para la entrevista ni para el walkthrough asociado (WT-03), que ya constaba invalidado desde la Entrega 3 (2A) \\ \hline
...
El repositorio sigue la jerarquía de carpetas establecida desde la Entrega 3 (2A) y vigente en esta Entrega Final (2B): 01\_ERS/ a 08\_Etica/, con los archivos raíz obligatorios (README.md, LICENSE, CITATION.cff, CHANGELOG.md, .gitignore, checksums.sha256).

\textbf{Zonas de evidencia [P]/[R] (actualización conforme a la guía vigente).} Toda la evidencia reside dentro del repositorio, organizada en dos zonas: \textbf{zona pública [P]} (transcripciones anonimizadas, copias de consentimientos con cédula y firma enmascaradas, fotografías sin rostros identificables y sin coordenadas GPS, documentos de la organización anonimizados, actas de validación enmascaradas, codificación temática, fichas técnicas de cada archivo multimedia) y \textbf{zona restringida [R]} (consentimientos originales, videos y audios sin anonimizar, actas con firma visible, documentos originales de la organización), almacenada en \nolinkurl{02_Evidencias/00_Restringido/} como contenedor cifrado con AES-256, cuya contraseña se entrega únicamente al docente por el canal institucional (nunca dentro del repositorio ni del README). El hash SHA-256 de cada archivo se calcula antes del cifrado y se registra en \texttt{checksums.sha256} junto con la ficha técnica pública, permitiendo al docente verificar la integridad de la evidencia sin que esta quede expuesta públicamente.
...
La carpeta \nolinkurl{08_Etica/} contiene el paquete ético completo (documentos A.1 a A.13 del Anexo A, subcarpeta específica de Categoría B, y \texttt{Adenda\_Segunda\_Ronda.pdf}), cuya vigencia es condición de admisión conforme al gatekeeper G8 de la guía.
