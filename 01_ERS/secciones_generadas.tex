...
comprobacion, esta en \texttt{01\_ERS/Componentes\_IA/ficha\_RF-09\_analisis\_predictivo\_fallos.md},
y la clasificacion de riesgo razonada en
\texttt{01\_ERS/Componentes\_IA/clasificacion\_riesgo\_ia.md}. Lo que sigue es su resumen
...
\texttt{01\_ERS/Componentes\_IA/trazado\_requisitos\_ia.csv} enlaza cada uno con los
...
Ocho requisitos, \textbf{RNF-IA-01} a \textbf{RNF-IA-08}, cubren los seis aspectos exigibles: predicción de uso de aulas, explicabilidad, equidad, supervisión humana sobre las acciones automáticas, monitoreo posterior al despliegue y clasificación del nivel de riesgo. Los ocho constan en \texttt{01\_ERS/Componentes\_IA/requisitos\_no\_funcionales\_ia.csv} con sus atributos completos, y \textbf{los ocho figuran en la matriz de trazabilidad}, cada uno vinculado al elemento de diseño que lo realiza y al caso de prueba que lo verifica.
...
\noindent\textbf{Plan de monitoreo.} RNF-IA-07 obliga a mantener en operación el plan de \texttt{01\_ERS/Componentes\_IA/plan\_monitoreo\_postdespliegue.md}, que desarrolla once indicadores con su periodicidad, su responsable, su umbral de alerta y \textbf{la acción concreta que se toma al superarlo}. Un indicador sin acción declarada no es un indicador, es una cifra.
