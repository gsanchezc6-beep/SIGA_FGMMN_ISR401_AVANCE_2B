...
\textit{Escenario }\textit{Gherkin}\textit{ --- Dado que el horario vigente está cargado y la última franja asignada al aula ha concluido, cuando el sensor confirma que el aula está desocupada, entonces el sistema ordena el apagado total en $\leq$2 minutos y la bitácora registra RF-16 como regla de origen.}
