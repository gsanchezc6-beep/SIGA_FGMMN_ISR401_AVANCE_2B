...
% Columna de ancho proporcional al ancho de texto: P{fraccion}. Las tablas se
% disenaron con anchos fijos en centimetros que, en A4 con margenes de 2,5 cm,
% sumaban mas que la caja de texto. Asi el ancho total nunca la excede.
\newcolumntype{P}[1]{>{\hspace{0pt}}p{\dimexpr #1\linewidth-2\tabcolsep-2\arrayrulewidth\relax}}
...
Cede\~no \'Avila Winston Dami\'an \textbar\ CI: 0942833492 \textbar\ wcedenoa2@uteq.edu.ec
\vspace{8mm}
...
\vspace{2mm}
Versi\'on \textbf{4.4} \textbar\ 07/09/2026 \textbar\ commit \texttt{d0a8cda}\\
L\'inea base etiquetada \texttt{2B-final-v4.0} en el repositorio declarado arriba.
\vspace{8mm}
...
transcritas y codificadas tematicamente --- el corpus del proyecto son dieciseis, y las
dieciseis quedaron codificadas el 7 de septiembre de 2026; las seis de la ronda terminal
del 3 de septiembre son posteriores a esta especificacion, de modo que los requisitos que
aqui constan no se derivan de ellas ---, y en un cuestionario aplicado a \textbf{sesenta}
