...
transcritas y codificadas tematicamente --- el corpus del proyecto son dieciseis, pero
las seis de la ronda terminal del 3 de septiembre de 2026 estan transcritas y aun no
codificadas, de modo que los requisitos de esta especificacion no se derivan de ellas ---, y en un cuestionario aplicado a \textbf{sesenta}
